# Generate code in C# for console application that reads a list of files and upload the files from the list to Amazon S3 storage using ProtoActor actor model library.
...
3. Using S3Uploader as a reference, create a similar application that uploads files using ProtoActor.
